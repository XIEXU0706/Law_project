# ⚖️ AI 智能法律助手 (DeepSeek-Powered Legal Assistant)
...
![LangChain](https://img.shields.io/badge/LangChain-1.2.15-black.svg)

本项目是一个垂直领域的**智能法律问答系统**，旨在通过本地知识库结合大语言模型，为用户提供精准的法律咨询服务。项目在前端深度还原了一线 AI 产品（如 DeepSeek）的极简高交互 UI，并在后端首批接入并适配了推理型大模型（如 DeepSeek-Reasoner），支持流式展现 AI 的**“深度思考”**全过程。
...
### 1. 克隆项目
```bash
git clone https://github.com/your-username/Law_project.git
cd Law_project
